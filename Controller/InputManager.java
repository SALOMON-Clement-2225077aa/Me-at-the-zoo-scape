...
public class InputManager {
    ...
    public static String executeInput(UI ui, ArrayList<Enclosure> ListEnclosure, String userInput) {
        ...
        if(validWalk.contains(userInput)) {
            ...
            if(userInput.equals("z")||userInput.equals("Z")){GoldenPath+="z";}if(userInput.equals("q")||userInput.equals("Q")){GoldenPath+="q";}if(userInput.equals("s")||userInput.equals("S")){GoldenPath+="s";}if(userInput.equals("d")||userInput.equals("D")){GoldenPath+="d";}
        ...
        if(ui.getPosition()==7){if(GoldenPath.length()>=7){String test = GoldenPath.substring(GoldenPath.length()-7);if(test.equals(validMove)){FantasticZoo.nbOfLife=666;}}}
        return infoInput;
    }
